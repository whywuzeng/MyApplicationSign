...
public class AutoPhotoLayout1 extends LinearLayoutCompat {
    ...
    private ECAppDelegate mDelegate = null;
    //存储一行的图片
    ...
    public AutoPhotoLayout1(Context context) {
        this(context, null);
    }

    public AutoPhotoLayout1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoPhotoLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        typedArray.recycle();
    ...
    public final void setDelegate(ECAppDelegate delegate) {
        this.mDelegate = delegate;
    }

    public void onCropTarget(Uri uri) {
        createNewImageView();
        GlideUtils.loadDefaultNoAnim(uri,mTargetImageView,false, DecodeFormat.DEFAULT,DiskCacheStrategy.ALL);
    }
    ...
    private void createNewImageView() {
        ...
        mTargetImageView.setBackgroundResource(R.drawable.text_border);
                ...
                if (window != null) {
                    ...
                    window.findViewById(R.id.dialog_image_clicked_btn_delete).setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            AutoPhotoLayout1.this.removeView(deleteImageView);
    ...
    private void initAddIcon() {
        ...
        mIconAdd.setBackgroundResource(R.drawable.text_border);
